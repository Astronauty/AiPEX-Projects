...
function fmincon(cost::Function,
                 ...
                 c_tol = 1e-4,
                 max_iters = 1_000,
                 verbose = true)::Tuple{Vector,Float64,Float64,MOI.TerminationStatusCode}
    ...
    solve_time_sec = MOI.get(solver, MOI.SolveTimeSec())

    return (res, objs, solve_time_sec, term_status)
