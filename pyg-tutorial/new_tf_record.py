...
def _read_metadata():
    with open('/Users/daniel/Documents/Python Projects/AiPEX-Projects/pyg-tutorial/data/raw/WaterDropSample/metadata.json', 'rt') as fp:
        return json.loads(fp.read()) 

metadata = _read_metadata()
ds = tf.data.TFRecordDataset(["/Users/daniel/Documents/Python Projects/AiPEX-Projects/pyg-tutorial/data/raw/WaterDropSample/test.tfrecord"])
...
# ptypes = lds[:][0]['particle_type'].numpy()
